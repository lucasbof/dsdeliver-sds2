...
const OrderDetails = ({ route }: Props) => {
    ...
    const handleConfirmDelivery = () => {
        ...
        confirmDelivery(order.id)
            .then(() => { 
                Alert.alert(`O pedido nº ${order.id} foi confirmado com sucesso!`)
                navigation.navigate('Orders');
            })
            .catch(() => Alert.alert(`Houve um erro ao confirmar o pedido nº ${order.id}!`))
    ...
    return (
        <>
            ...
            <View style={styles.container}>
                ...
                {isLoading ? (
                    <Text style={styles.loadingMessage}>Confirmando pedido...</Text>
                ) : (
                <>
